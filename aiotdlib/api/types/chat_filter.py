...
class ChatFilter(BaseObject):
    ...
    :param included_chat_ids: The chat identifiers of always included chats in the filtered chat list
    :type included_chat_ids: :class:`list[int]`
    
    :param excluded_chat_ids: The chat identifiers of always excluded chats in the filtered chat list
